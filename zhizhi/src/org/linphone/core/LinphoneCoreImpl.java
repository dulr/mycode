...
class LinphoneCoreImpl implements LinphoneCore {
	...
	private native long inviteAddressWithParams(long nativePtrLc, long to,
			long nativePtrParam);
	...
	public LinphoneCall invite(LinphoneAddress to) throws LinphoneCoreException {
		long lNativePtr = inviteAddress(nativePtr,
	...
	public LinphoneCall inviteAddressWithParams(LinphoneAddress to,
		...
		long lcNativePtr = inviteAddressWithParams(nativePtr, ptrDestination,
				ptrParams);
		if (lcNativePtr != 0) {
