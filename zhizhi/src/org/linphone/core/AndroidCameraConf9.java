...
public class AndroidCameraConf9 extends AndroidCameraConf {
	...
	public void findFrontAndRearCameraIds9(Integer frontCameraId,
			Integer rearCameraId, Integer cameraId) {
	...
	public boolean isFrontCamera(int cameraId) {
		android.hardware.Camera.CameraInfo info = new android.hardware.Camera.CameraInfo();
		Camera.getCameraInfo(cameraId, info);
		return info.facing == android.hardware.Camera.CameraInfo.CAMERA_FACING_FRONT ? true
				: false;
	}
}
