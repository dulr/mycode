 ...
 * 
 */
public class AddCarInfoDialog extends Dialog {

    public AddCarInfoDialog(Context context, int theme) {
        super(context, theme);
    }

    public AddCarInfoDialog(Context context) {
        super(context);
    }
    ...
    public static class Builder {
         ...
         */
        public AddCarInfoDialog create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            final AddCarInfoDialog dialog = new AddCarInfoDialog(context,
                    R.style.Dialog);
            View layout = inflater.inflate(R.layout.activity_addcarinfo_dialog,
                    null);
