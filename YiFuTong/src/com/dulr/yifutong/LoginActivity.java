...
import com.dulr.yifutong.utils.Utils;
...
public class LoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mimageViewtCheck = (ImageView) findViewById(R.id.imageViewtCheck);
        mimageViewtCheck.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View v) {
                mIsPwRemembered = !mIsPwRemembered;
                mimageViewtCheck
                        .setBackgroundResource(mIsPwRemembered ? R.drawable.btn_check_on
...
//        });
    ...
    void tryToLogin() {
        ...
        mProgressDialog = Utils.createProgressDialog(this, "正在登陆");
