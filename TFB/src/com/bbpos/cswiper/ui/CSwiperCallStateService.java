...
public class CSwiperCallStateService extends Service {
	...
	public static final String INTENT_ACTION_INCOMING_CALL = "com.bbpos.cswiper.INCOMING_CALL";
	...
	private static final String LOG_TAG = CSwiperCallStateService.class.getName();
