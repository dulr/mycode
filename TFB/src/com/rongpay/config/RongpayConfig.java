 ...
 *2、更换浏览器或电脑，重新登录查询。
 * */
package com.rongpay.config;

public class RongpayConfig {
	
	//↓↓↓↓↓↓↓↓↓↓请在这里配置您的基本信息↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
	// 合作身份者ID，由纯数字组成的字符串
	public static String merchant_ID = "100000000002862";
	
	//交易安全检验码，由数字和字母组成的32位字符串
	public static String key = "0e7201cd040fa7292c9102caga55dae3acc91c90465dbeccddc81gd7bg405f67";
	//签约融宝支付账号或卖家收款融宝支付帐户
	public static String seller_email = "542902558@qq.com";
	...
	public static String rongpay_url="http://epay.reapal.com/portal";
	//返回验证订单地址
