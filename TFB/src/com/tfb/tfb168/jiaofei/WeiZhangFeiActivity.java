...
public class WeiZhangFeiActivity extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_weizhangfei);
    ...
    Handler mHandler = new Handler() {
        public void handleMessage(android.os.Message msg) {
            ...
            case 1:
                ...
                intent.setClass(WeiZhangFeiActivity.this, MainActivity.class);                
